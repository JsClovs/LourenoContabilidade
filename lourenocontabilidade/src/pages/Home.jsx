  ...
  return (
    <>
      <section
        ...
        <div className="bg-gray-950/50 h-125 p-10 mx-10 text-white flex flex-col w-125 justify-center">
            <h1 className="text-2xl z-100">Com sua tradição e confiança</h1>
